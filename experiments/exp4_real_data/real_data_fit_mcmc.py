...
-----------
    ...
    python real_data_fit_nls.py     # must run first -- provides rho
    python real_data_fit_mcmc.py
...
DEPENDENCIES
-------------
numpy, pandas, matplotlib, pymc, and the companion module seir_model.py.
